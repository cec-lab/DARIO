regole <- c(
  ...
  "is.na(syndrome) & is.na(malfo1)",
  "!is.na(omim) & is.na(syndrome)",
  "nbrbaby == 2 & nbrmalf == 2 & (is.na(prevsib) | prevsib != 1)",
  "firsttri %in% c(2,9) & !is.na(drugs1)",
  "firsttri %in% c(2,9) & !is.na(drugs2)",
  "firsttri %in% c(2,9) & !is.na(drugs3)",
  "firsttri %in% c(2,9) & !is.na(drugs4)",
  "firsttri %in% c(2,9) & !is.na(drugs5)",
  "firsttri %in% c(2,9) & !is.na(extra_drugs)",
  ...
  "!is.na(malfo1) & (is.na(sp_malfo1) | sp_malfo1 == '')",
  "!is.na(malfo2) & (is.na(sp_malfo2) | sp_malfo2 == '')",
  "!is.na(malfo3) & (is.na(sp_malfo3) | sp_malfo3 == '')",
  "!is.na(malfo4) & (is.na(sp_malfo4) | sp_malfo4 == '')",
  "!is.na(malfo5) & (is.na(sp_malfo5) | sp_malfo5 == '')",
  "!is.na(malfo6) & (is.na(sp_malfo6) | sp_malfo6 == '')",
  "!is.na(malfo7) & (is.na(sp_malfo7) | sp_malfo7 == '')",
  "!is.na(malfo8) & (is.na(sp_malfo8) | sp_malfo8 == '')",
  "!is.na(moanom) & moanom %in% c(1,2,3) & (is.na(sp_moanom) | sp_moanom == '')",
  "!is.na(sibanom) & sibanom %in% c(1,2,3) & (is.na(sp_sibanom) | sp_sibanom == '')",
  "!is.na(syndrome) & (is.na(sp_syndrome) | sp_syndrome == '')",
  ...
  "survival == 2 & !is.na(death_date) & !is.na(birth_date) & !grepl('x', death_date) & !grepl('x', birth_date) & abs(as.Date(death_date, '%d/%m/%Y') - as.Date(birth_date, '%d/%m/%Y')) > 7",
  "!is.na(agemo) & totpreg != 99 & ((agemo <= 15 & totpreg > 1) | (agemo >= 16 & agemo <= 19 & totpreg > 2))",
  "!is.na(illdur1) & nchar(illdur1) > 4",
  "!is.na(illdur2) & nchar(illdur2) > 4",
  "survival == 1 & type != 1",
  "survival == 3 & type != 1",
